...
public class ProjectPropertiesDialog extends JDialog {
	...
	public ProjectPropertiesDialog(GraphProjectVO graphProject) {
		...
		JButton btnVerifyAndroidProject = new JButton("");
